...
def make_hash():
    ...
    output.insert(END,'String Hashed: ' + entered_text + '\n' + 'Algorithm Type: ' + selection + '\nHash:' + hashed_string.hexdigest())
...
Label (window, image=logo, bg='black') .grid(row=1, column=2, sticky=S)

Label (window, text='Hash Generator Application', bg='black', fg='white', font='none 12 bold') .grid(row=0, column=2, sticky=N)

Label (window, text='Enter a string to hash', bg='black', fg='white', font='none 10 bold') .grid(row=2, column=2, sticky=N)

textentry = Entry(window, width=90, bg='white')
textentry.grid(row=3, column=2, sticky=W)

algorithm = StringVar()
but1 = Radiobutton(window, text='SHA 224', width=10, bg='black', fg='red', activebackground='black', activeforeground='red', command=set_sha_224, variable=algorithm, value='SHA 224 bit', cursor='spider') .place(x=5, y=55)
but2 = Radiobutton(window, text='SHA 256', width=10, bg='black', fg='red', activebackground='black', activeforeground='red', command=set_sha_256, variable=algorithm, value='SHA 256 bit', cursor='spider') .place(x=5, y=85)
but3 = Radiobutton(window, text='SHA 384', width=10, bg='black', fg='red', activebackground='black', activeforeground='red', command=set_sha_384, variable=algorithm, value='SHA 384 bit', cursor='spider') .place(x=5, y=115)
but4 = Radiobutton(window, text='SHA 512', width=10, bg='black', fg='red', activebackground='black', activeforeground='red', command=set_sha_512, variable=algorithm, value='SHA 512 bit', cursor='spider') .place(x=5, y=145)
but5 = Radiobutton(window, text='Blake2s', width=10, bg='black', fg='red', activebackground='black', activeforeground='red', command=set_blake2s, variable=algorithm, value='Blake2s', cursor='spider') .place(x=5, y=175)
but6 = Radiobutton(window, text='SHA3 256', width=10, bg='black', fg='red', activebackground='black', activeforeground='red', command=set_sha3_256, variable=algorithm, value='SHA3 256 bit', cursor='spider') .place(x=90, y=55)
but7 = Radiobutton(window, text='SHA3 384', width=10, bg='black', fg='red', activebackground='black', activeforeground='red', command=set_sha3_384, variable=algorithm, value='SHA3 384 bit', cursor='spider') .place(x=90, y=85)
but8 = Radiobutton(window, text='SHA3 512', width=10, bg='black', fg='red', activebackground='black', activeforeground='red', command=set_sha3_512, variable=algorithm, value='SHA3 512 bit', cursor='spider') .place(x=90, y=115)
but9 = Radiobutton(window, text='Blake2b', width=10, bg='black', fg='red', activebackground='black', activeforeground='red', command=set_blake2b, variable=algorithm, value='Blake2b', cursor='spider') .place(x=90, y=145)
but10 = Radiobutton(window, text='MD5', width=10, bg='black', fg='red', activebackground='black', activeforeground='red', command=set_md5, variable=algorithm, value='MD5', cursor='spider') .place(x=90, y=175)

output = Text(window, width=75, height=6, wrap=WORD, background='white')
output.grid(row=28, column=2, sticky=S)

submit_button = Button(window, text='Submit', width=6, bg='black', fg='red', activebackground='red', command=make_hash) .grid(row=3, column=2, sticky=E)
